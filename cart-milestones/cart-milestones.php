<?php
/**
 * Plugin Name:       Cart Milestones
 * Plugin URI:        https://github.com/YOUR_ORG/cart-milestones
 * Description:       Increase Average Order Value through milestone-based rewards, progress tracking, and gamification.
 * Version:           1.0.0
...
define( 'CM_GITHUB_REPO', 'YOUR_ORG/cart-milestones' );
			...
			add_action(
				...
				static function (): void {
					echo '<div class="notice notice-error"><p>' .
						esc_html__( 'Cart Milestones requires WooCommerce 9.0 or higher.', 'cart-milestones' ) .
						'</p></div>';
				}
			);
			return;
